            ...
            dal.getObjects(filter,null,function(err,data){
                if(data){
                    ...
                    rows.forEach(function(element) {
                        element["name"] = cache[element.pId] && cache[element.pId].name;
                        element["cardNum"] = cache[element.pId] && cache[element.pId].cardNum;
                        element["phone"] = cache[element.pId] && cache[element.pId].phone;
                    }, this);
                }
                callback(err,rows);
            });
