...
tableAccess.prototype = unit.inherits({
    getColumns:function(){
        return {
             ...
             "finalAddr": "null", //目的网格
             "outDeleteDate": "t1.DELETE_DATE",//移除时间
    ...
    getTable:function(){
        return  "ZZ_ZSZH_DELETEHIS t1 INNER JOIN ZZ_ZSZHJSB t4 ON t1.Z_ID=t4.ID  LEFT JOIN ZZ_PERSON t2 ON t2.ID=t4.P_ID LEFT JOIN A4_SYS_DEPARTMENT t3 ON t3.DEPARTMENTID=t2.G_ID LEFT JOIN ZZ_ZSZH_MOVEOUTHIS t5 on t5.FINAL_ADDR=t1.ORIGINAL_ADDR"  ;
    }
