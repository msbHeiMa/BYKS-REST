...
tableAccess.prototype = unit.inherits({
    getColumns: function () {
        return {
            ...
            "actionName":"t1.ACTOIN_NAME",//审核结果
            "funModleId":"t7.FUNM_ID",
    ...
    getTable: function () {//2 or t3.Z_ID=t10.ID
        return `WF_APPROVEHIS t1 LEFT JOIN WF_APPROVEHIS t2 ON t1.FUNMDATA_ID=t2.FUNMDATA_ID
                LEFT JOIN WF_BUSI_PROC t7 ON t7.FUNMDATA_ID=t1.FUNMDATA_ID
                LEFT JOIN WF_BUSI_CONFIG t3  ON t3.FUNMODEL_ID=t7.FUNM_ID
                LEFT JOIN A4_SYS_USERINPOST t4 ON t4.USERID=t2.USER_ID
                LEFT JOIN A4_SYS_POSTINFO t5 ON t5.POSTID=t4.POSTID
                LEFT JOIN A4_SYS_USER t6 ON t6.USERID=t2.USER_ID
                `
    },
    getJoinJSB: function () {
