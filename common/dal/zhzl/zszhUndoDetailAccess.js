 ...
 //WF_BUSI_CONFIG t9
    ...
    getTable: function () {//2 or t3.Z_ID=t10.ID
        return `WF_TASKTODO t1 LEFT JOIN WF_APPROVEHIS t2 ON t1.FUNMDATA_ID=t2.FUNMDATA_ID
                ...
                LEFT JOIN ZZ_ZSZHJSB t10 ON t10.ID=t1.FUNMDATA_ID 
                LEFT JOIN ZZ_ZSZHJSB t11 ON t11.ID=t3.Z_ID
                LEFT JOIN ZZ_PERSON t4 ON t4.ID=t10.P_ID
                LEFT JOIN ZZ_PERSON t12 ON t12.ID=t11.P_ID
                LEFT JOIN A4_SYS_USERINPOST t5 ON t5.USERID=t1.USER_ID
                ...
                LEFT JOIN WF_BUSI_CONFIG t9 ON t9.FUNMODEL_ID=t8.FUNMDATA_ID`
    },
